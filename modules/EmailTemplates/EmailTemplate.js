...
firstRun=false;var text_only=document.getElementById('text_only');if(firstRun){setTimeout("tinyMCE.execCommand('mceAddEditor', false, 'body_text');",500);var tiny=tinyMCE.get('body_text');}
...
function insert_variable_html(text){var inst=tinyMCE.get("body_text");if(inst)
