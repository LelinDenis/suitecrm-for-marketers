...
(function($) {
  ...
  var defaults = {
  	height:		'140px',	// Height of containerobj
    multi:      false,		// Allow multiple selections
    preview:    displayFields,		// Handler for preview pane
        ...
        if ($self.hasClass("hasChildMenu")) {
          ...
          if (settings.preview) {
			  ...
			  if ($.isFunction(settings.preview)) {
				...
				var preview = settings.preview($self,$container);
			  } else {
